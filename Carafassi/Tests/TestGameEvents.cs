...
namespace Pokaiju.Carafassi.Tests
{
    ...
    public class TestGameEvents
    {
        ...
        public void SetUp()
        {
            ...
            IMonsterSpecies monsterSpeciesA = new MonsterSpeciesBuilder().Name("MonsterA")
            ...
            IMonsterSpecies monsterSpeciesB = new MonsterSpeciesBuilder().Name("MonsterB")
                .MovesList(movesSpecies)
            ...
            IMonsterSpecies monsterSpeciesC = new MonsterSpeciesBuilder().Name("MonsterA")
                .MovesList(movesSpecies)
        ...
        {
            Tuple<int, int> startingPosition = new Tuple<int, int>(10, 10);
            Tuple<int, int> newPosition = new Tuple<int, int>(2, 0);
        ...
        private IGameMap InitMonsterSpawnMap(Tuple<int, int> eventPosition, IList<INpcSimple> npcs,
        ...
        public void UniqueMonsterSpawn()
        {
            ...
            Tuple<int, int> eventPosition = new Tuple<int, int>(10, 10);
            ...
            IGameMap map = InitMonsterSpawnMap(eventPosition, new List<INpcSimple>() {mario}, monsterEvent);
