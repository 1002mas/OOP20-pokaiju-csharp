...
public abstract class AbstractGameEvent : IGameEvent
{
    ...
    public void Activate()
    {
        ...
        // disable events
        foreach (var e in _eventsToDeactivate)
        {
            e.Active = false;
        }

        // enable events
        foreach (var e in _eventsToActivate)
        {
            e.Active = true;
    ...
    private bool Equals(IGameEvent other)
    {
    ...
    public override bool Equals(object? obj)
    {
        ...
        return obj.GetType() == GetType() && Equals((AbstractGameEvent) obj);
    }
